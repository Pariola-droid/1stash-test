...
import { loginAdmin, setLoading, clearMsg } from '../../actions/authActions'
...
const AdminEntry = ({
	...
	if (userToken !== null) {
		...
		return <Redirect to={url.adminHome} />
	}
...
export default connect(mapStateToProps, { loginAdmin, setLoading, clearMsg })(
	AdminEntry
)
